...
#define STRING_CONFIG_H_AUTHOR "(padfoot, Ender3-1.5)" // Who made the changes.
...
// #define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT ((X_BED_SIZE - MESH_INSET) / 2)    // X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT ((Y_BED_SIZE - MESH_INSET) / 2)    // Y point for Z homing
#endif
